        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-white rounded-[4px] border border-gray-100 p-6 md:p-8 w-full max-w-lg max-h-[90vh] overflow-y-auto"
            >
              {/* Header */}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h3 className="text-2xl font-medium text-gray-900">Add Owner Info</h3>
                        <p className="text-gray-500 text-xs">Outreach Tracking</p>
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-[4px] px-4 py-3 mt-3">
                      <p className="text-sm text-gray-700">
                        <span className="font-medium text-gray-900">Store:</span> {retailer?.name}
                      </p>
                      {retailer?.address && (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={3}
                    className="w-full px-4 py-3 rounded-[4px] border border-gray-200 outline-none focus:ring-2 focus:ring-[#ff6fb3] focus:border-transparent transition-all resize-none"
                  ...
                  <motion.button
                    ...
                    className={[
                      ...
                      success
                        ...
                        : "bg-gradient-to-r from-[#ff7a4a] to-[#ff6fb3] text-white disabled:opacity-50"
                    ].join(" ")}
                  >
                    {success ? (
