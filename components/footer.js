        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t-2 border-gray-200">
              <p className="text-gray-700 text-sm font-medium mb-2">
                Have questions? Feel free to call and chat!
              </p>
              <motion.a
                href="tel:+17159791259"
                whileHover={{ scale: 1.02 }}
                className="inline-flex items-center gap-2 text-lg font-bold bg-gradient-to-r from-[#ff7a4a] to-[#ff6fb3] bg-clip-text text-transparent"
              >
                <svg className="h-5 w-5 text-[#ff7a4a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t-2 border-gray-200">
              ...
              <motion.a
                href="mailto:oscar@pawpayaco.com"
                whileHover={{ scale: 1.02 }}
                className="inline-flex items-center gap-2 text-sm font-bold bg-gradient-to-r from-[#ff7a4a] to-[#ff6fb3] bg-clip-text text-transparent"
              >
                <svg className="h-4 w-4 text-[#ff7a4a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
