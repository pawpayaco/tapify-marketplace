      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white text-xl font-bold">Tapify Marketplace</h3>
            <p className="text-gray-400 text-sm">
              Your premier destination for discovering and connecting with local vendors.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/onboard" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Vendor Onboarding
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Tapify Marketplace. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
