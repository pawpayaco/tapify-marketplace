      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 pb-8 md:pb-12">
        <section className="text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 bg-gray-100 px-4 py-2.5 rounded-full mb-8 mt-8 md:mt-12 text-xs md:text-sm font-medium text-gray-700"
          >
            <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse flex-shrink-0"></span>
            <span className="whitespace-nowrap">Free display • Zero inventory • Auto commissions</span>
          </motion.div>

          <h1 className="text-6xl sm:text-7xl md:text-8xl font-medium text-gray-900 mb-6 leading-tight">
            Meet Pawpaya
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
            <Link href="/onboard">
              <button
                className="bg-gradient-to-r from-[#ff7a4a] to-[#ff6fb3] text-white px-8 py-4 rounded-[4px] text-lg font-medium transition-all hover:scale-105"
              >
            ...
            <a
              href="#how-it-works"
              className="bg-white border-4 px-8 py-4 rounded-[4px] text-lg font-medium transition-all hover:scale-105 inline-block cursor-pointer"
        ...
        >
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="flex flex-col md:grid md:grid-cols-[2.25fr_1fr] gap-8 items-center max-w-6xl mx-auto">
              <div className="order-2 md:order-none bg-white rounded-[4px] p-7 md:p-10 ">
                <p className="text-xl md:text-2xl text-gray-600 text-left leading-relaxed">
                  Bring joy to your store with this free Pawpaya marketing display! Customers can tap-to-buy our matching collar and bracelet sets — you earn extra profit automatically. Cute, modern, and made to make tails wag!                </p>
              </div>
          ...
          <div className="flex flex-col gap-8 md:gap-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="aspect-square rounded-[4px] overflow-hidden bg-white transition-shadow"
                >
                  <img
                    src={`/images/${filename}`}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="order-1 md:order-none mt-0 md:mt-12 mb-4 bg-white border border-purple-200 rounded-[4px] p-8 md:p-10 text-center"
            >
              ...
              <a
                ...
                className="inline-block px-8 py-4 rounded-[4px] text-lg md:text-xl font-medium text-white transition-all hover:scale-105"
            ...
            <div className="contents md:grid md:grid-cols-2 md:gap-8 md:gap-12">
              {/* Left: What You Get */}
              <div className="order-2 bg-white to-white border border-gray-200 rounded-[4px] p-8 md:p-10">
              ...
              <div className="order-4 md:order-none bg-white to-white border border-gray-200 rounded-[4px] p-8 md:p-10">
                ...
                <div className="space-y-8">
                  {[
                    ...
                    <div key={idx} className="flex gap-4 items-start">
                      <div className="w-10 h-10 flex-shrink-0 rounded-full bg-gradient-to-br from-[#ff7a4a] to-[#ff6fb3] flex items-center justify-center text-white font-medium text-lg">
                        {item.step}
                      </div>
          ...
          >
            <div className="rounded-[4px] md:rounded-[4px] p-6 md:p-10 text-white"
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/onboard">
                  <button
                    className="bg-white px-10 md:px-12 py-4 md:py-5 rounded-[4px] md:rounded-[4px] text-lg md:text-xl font-medium transition-all whitespace-nowrap"
                    style={{ color: '#ff6fb3' }}
                  >
                ...
                <button
                  ...
                  className="bg-transparent border border-white px-10 md:px-12 py-4 md:py-5 rounded-[4px] md:rounded-[4px] text-lg md:text-xl font-medium transition-all text-white hover:bg-white hover:bg-opacity-10 whitespace-nowrap"
                >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="mb-8 md:mb-12 bg-white border border-orange-200 rounded-[4px] p-6 md:p-8"
          >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="mb-0 bg-white rounded-[4px] p-5 md:p-6 border border-transparent text-center"
          >
