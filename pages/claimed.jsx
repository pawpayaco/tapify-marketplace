...
export default function ClaimedPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4 sm:px-6 pt-24 sm:pt-32 pb-12 sm:pb-16">
      <div className="max-w-lg w-full relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <div className="inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-green-400 to-green-500 rounded-full shadow-xl">
              <motion.span
            ...
            {[...Array(12)].map((_, i) => (
              <motion.div
                ...
                style={{
                  ...
                  height: '10px',
                  borderRadius: '50%',
                  backgroundColor: ['#ff7a4a', '#ff6fb3', '#ff8c69', '#ff88b7', '#ffa084'][i % 5],
                }}
              />
            ))}
          </>
