...
export async function handleClaimRequest(req, res) {
  ...
  try {
    ...
    console.log('[claimDisplay] 🔍 DEBUG - Checking affiliate URL...');
    console.log('[claimDisplay] 🔍 DEBUG - uidRecord?.affiliate_url:', affiliateUrl);

    if (!affiliateUrl) {
      // Generate affiliate URL - NO SHOPIFY DOMAIN CHECK NEEDED
      // We use pawpayaco.com directly
      ...
      console.log('[claimDisplay] ✅ Using existing affiliate URL:', affiliateUrl);
    }
